...
- **Free evaluation sample** on GitHub (`3d`) · **11 timeframes** on [getdata.finance](https://getdata.finance/datasets/aus200) · **2,182** `3d` rows in the full archive
- Built for **backtesting**, **algorithmic trading** and **quantitative finance** workflows
- **Weekly refresh** — [getdata.finance](https://getdata.finance) every **Saturday, 8am UTC+0**; GitHub `3d` sample updated in sync

> **Sample on GitHub** · `AUS200_3d.csv` (244 rows, `2024-09-05` -> `2026-09-07`, 19.98 KB). **Full archive on [getdata.finance](https://getdata.finance/datasets/aus200)** — **2,182** `3d` rows (full `1m`: 5,046,226), **11 timeframes**, `2008-09-08` -> `2026-09-07`.
...
| 3d rows | 244 | **2,182** |
| Size | 19.98 KB | full ZIP on [getdata.finance](https://getdata.finance/datasets/aus200) |
| Period | `2024-09-05` -> `2026-09-07` | `2008-09-08` -> `2026-09-07` |
...
| 2026-09-07T00:00:00+00:00 | 8994.04 | 9042.94 | 8884.34 | 8892.11 | 33265 |
...
The complete **AUS200** archive on **[getdata.finance](https://getdata.finance/datasets/aus200)** includes **11 OHLCV timeframes** (1m · 3m · 5m · 15m · 30m · 1H · 4H · 12H · 1D · 3D · 1W) — **2,182** rows at `3d`, plus all other timeframes in the same ZIP.
